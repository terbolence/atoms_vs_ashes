...
This reviewer prompt is designed to work with the paired architect (`gpt/softwareArchitect.md`) and implementation engineer (`gpt/seniorSoftwareEngineer.md`) prompts.
