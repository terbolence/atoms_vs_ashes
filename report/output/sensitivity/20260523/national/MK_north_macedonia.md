# North Macedonia (MK) — sensitivity shortlist — 20260523
...
| 2 | Negotino power station | MK | B | 0.1765 | 0.8824 | 0.8824 |
| 3 | Oslomej power station | MK | D | 0.0588 | 0.1176 | 0.8235 |
| 4 | Mariovo power station | MK | H | 0.0 | 0.0 | 0.0 |

**Band counts:** A=1, B=1, C=0, D=1, E=0, F=0, G=0, H=1.
...
| ---: | --- | --- | :---: | ---: | ---: | ---: |
| 1 | Bitola power station | MK | A | 1.0 | 1.0 | 1.0 |
| 2 | Negotino power station | MK | B | 0.1176 | 0.8235 | 0.8824 |
| 3 | Oslomej power station | MK | D | 0.0 | 0.0588 | 0.8235 |
| 4 | Mariovo power station | MK | H | 0.0 | 0.0 | 0.0 |

**NuScale band counts:** A=1, B=1, C=0, D=1, E=0, F=0, G=0, H=1.
...
- Sources: `20260523_site_bands_MK.csv`, `20260523_site_bands_MK_nuscale_voygr6.csv`.
