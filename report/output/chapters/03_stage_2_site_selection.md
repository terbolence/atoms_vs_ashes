...
The traceability matrix maps the project criteria to SSR-1 requirements. Many safety requirements are covered fully at screening resolution, including seismic ground motion, capable faults, meteorological hazards, flooding, geotechnical hazards, external human events, population characteristics, emergency planning, atmospheric dispersion, water dispersion, and combinations of hazards [2], [5]. Some requirements are only partially covered because no desk study can close them out. Long-term radioactive material accumulation, engineered site protection, monitoring obligations, quality assurance, and operational responsibilities require later-stage programme and regulator work.
