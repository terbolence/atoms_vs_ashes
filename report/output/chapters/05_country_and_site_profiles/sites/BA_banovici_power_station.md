...
| Grid Connection (NS-02) | Nearest substation 6.69 km, nearest HV line 12.7 km at 220 kV; 350 MW grid-export capacity; **active avoidance flag** | 350 MW falls below the 924 MW NuScale VOYGR-6 12-module gross output; existing interconnection cannot absorb a full deployment without a corridor uprate | Confirm the 220 kV corridor uprate pathway with Elektroprenos BiH and update NS-02 against the planned topology | grid |
