...
- For NH-08 / A9 coastal flooding, do not convert a missing
  `distance_to_coast_km` / `coast_distance_km` value into a clear
  screening pass. If the NH-08 row is unscored, low-quality, or has an
  A9 caution / inconclusive verdict, state that coastal storm-surge /
