# Belarus (BY) — sensitivity shortlist — 20260425
...
![Top sites in Belarus](figures/BY_top_sites.png)

## Ranked shortlist — all SMRs pooled (top 10)

| Rank | Site | Country | Band | Top-5 % rate | Top-10 % rate | Top-30 % rate |
| ---: | --- | --- | :---: | ---: | ---: | ---: |
| 1 | Zelwa power station | BY | A | 1.0 | 1.0 | 1.0 |
| 2 | Lelchitsy power station | BY | H | 0.0 | 0.0 | 0.0 |

**Band counts:** A=1, B=0, C=0, D=0, E=0, F=0, G=0, H=1.
...
**NuScale band counts:** A=1, B=0, C=0, D=0, E=0, F=0, G=0, H=1.
...
- Sources: `20260425_site_bands_BY.csv`, `20260425_site_bands_BY_nuscale_voygr6.csv`.
