# North Macedonia (MK) — sensitivity shortlist — 20260425b

_Generated on 2026-04-25 (UTC)._

## Envelope

- Scored sites (all-SMR pool): **4**.
- Scored sites (NuScale pool): **4**.
...
![Top sites in North Macedonia](figures/MK_top_sites.png)

## Ranked shortlist — all SMRs pooled (top 10)

| Rank | Site | Country | Band | Top-5 % rate | Top-10 % rate | Top-30 % rate |
| ---: | --- | --- | :---: | ---: | ---: | ---: |
| 1 | Bitola power station | MK | A | 1.0 | 1.0 | 1.0 |
| 2 | Negotino power station | MK | D | 0.0 | 0.0 | 0.7857 |
| 3 | Mariovo power station | MK | G | 0.0 | 0.0 | 0.2143 |
| 4 | Oslomej power station | MK | H | 0.0 | 0.0 | 0.0 |

**Band counts:** A=1, B=0, C=0, D=1, E=0, F=0, G=1, H=1.
...
| ---: | --- | --- | :---: | ---: | ---: | ---: |
| 1 | Bitola power station | MK | A | 1.0 | 1.0 | 1.0 |
| 2 | Mariovo power station | MK | H | 0.0 | 0.0 | 0.1429 |
| 3 | Oslomej power station | MK | H | 0.0 | 0.0 | 0.0 |
| 4 | Negotino power station | MK | H | 0.0 | 0.0 | 0.0 |

**NuScale band counts:** A=1, B=0, C=0, D=0, E=0, F=0, G=0, H=3.
...
- Sources: `20260425b_site_bands_MK.csv`, `20260425b_site_bands_MK_nuscale_voygr6.csv`.
