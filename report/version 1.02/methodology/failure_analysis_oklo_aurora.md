# Phase 1.6 failure-mode analysis — 20260425b — Oklo Aurora
...
Source artefacts:
- `audit/post_processing/06_scoring/per_smr/oklo_aurora/20260425b_failure_summary.csv` — top-level counts.
- `audit/post_processing/06_scoring/per_smr/oklo_aurora/20260425b_failure_per_criterion.csv` — per-criterion fails.
- `audit/post_processing/06_scoring/per_smr/oklo_aurora/20260425b_failure_per_country.csv` — per-country fails.
- `audit/post_processing/06_scoring/per_smr/oklo_aurora/20260425b_failure_per_pair.csv` — one row per (site, SMR).
...
![Failure funnel](../output/sensitivity/20260425b/figures/failure/per_smr/oklo_aurora/failure_funnel.png)
...
![Failures by criterion](../output/sensitivity/20260425b/figures/failure/per_smr/oklo_aurora/failures_by_criterion.png)
...
![Per-country outcomes](../output/sensitivity/20260425b/figures/failure/per_smr/oklo_aurora/failures_by_country.png)
...
![Multi-failure histogram](../output/sensitivity/20260425b/figures/failure/per_smr/oklo_aurora/multi_failure_histogram.png)
