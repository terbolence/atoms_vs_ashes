# Phase 1.6 failure-mode analysis — 20260523
...
Source artefacts:
- `audit/post_processing/06_scoring/20260523_failure_summary.csv` — top-level counts.
- `audit/post_processing/06_scoring/20260523_failure_per_criterion.csv` — per-criterion fails.
- `audit/post_processing/06_scoring/20260523_failure_per_country.csv` — per-country fails.
- `audit/post_processing/06_scoring/20260523_failure_per_smr.csv` — per-SMR fails.
- `audit/post_processing/06_scoring/20260523_failure_per_pair.csv` — one row per (site, SMR).
...
![Failure funnel](../output/report/sensitivity/20260523/figures/failure/failure_funnel.png)
...
![Failures by criterion](../output/report/sensitivity/20260523/figures/failure/failures_by_criterion.png)
...
![Per-country outcomes](../output/report/sensitivity/20260523/figures/failure/failures_by_country.png)
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| NuScale VOYGR-6 | `nuscale_voygr6` | 362 | 304 | 84.0% | 57 | 1 | 0 |

![Per-SMR outcomes](../output/report/sensitivity/20260523/figures/failure/failures_by_smr.png)
...
![Multi-failure histogram](../output/report/sensitivity/20260523/figures/failure/multi_failure_histogram.png)
