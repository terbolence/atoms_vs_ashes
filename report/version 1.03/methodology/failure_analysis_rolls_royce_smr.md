# Phase 1.6 failure-mode analysis — 20260523 — Rolls-Royce SMR
...
Source artefacts:
- `audit/post_processing/06_scoring/per_smr/rolls_royce_smr/20260523_failure_summary.csv` — top-level counts.
- `audit/post_processing/06_scoring/per_smr/rolls_royce_smr/20260523_failure_per_criterion.csv` — per-criterion fails.
- `audit/post_processing/06_scoring/per_smr/rolls_royce_smr/20260523_failure_per_country.csv` — per-country fails.
- `audit/post_processing/06_scoring/per_smr/rolls_royce_smr/20260523_failure_per_pair.csv` — one row per (site, SMR).
...
![Failures by criterion](../output/report/sensitivity/20260523/figures/failure/per_smr/rolls_royce_smr/failures_by_criterion.png)
...
![Multi-failure histogram](../output/report/sensitivity/20260523/figures/failure/per_smr/rolls_royce_smr/multi_failure_histogram.png)
