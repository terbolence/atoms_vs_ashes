...
See the canonical glossary in [`failure_analysis.md` § Glossary](./failure_analysis.md#glossary). Terms are identical across the global and SMR-specific failure reports; only the population filter changes (this file is the `smr_key = nuscale_voygr6` filter).
...
Pivot view: Pivot view: per-criterion failure counts filtered to `smr_key = nuscale_voygr6`. Canonical home: `failure_analysis.md` § 2. Source: `audit/post_processing/06_scoring/20260523_failure_breakdown_nuscale_voygr6_per_criterion.csv` (slice `smr_key=nuscale_voygr6`)._
...
Pivot view: Pivot view: per-country survivorship filtered to `smr_key = nuscale_voygr6`. Canonical home: `failure_analysis.md` § 3. Source: `audit/post_processing/06_scoring/20260523_failure_breakdown_nuscale_voygr6_per_country.csv` (slice `smr_key=nuscale_voygr6`)._
...
Pivot view: Pivot view: compound-failure histogram filtered to `smr_key = nuscale_voygr6`. Canonical home: `failure_analysis.md` § 5. Source: `audit/post_processing/06_scoring/20260523_failure_breakdown_nuscale_voygr6_multi_failure.csv` (slice `smr_key=nuscale_voygr6`)._
