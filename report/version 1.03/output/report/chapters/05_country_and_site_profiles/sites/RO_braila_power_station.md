...
- **Extreme Winds (NH-10)** - score 9.5/10 (MC 9.0-10.0), weight n/a, data quality medium. Evidence: screening wind-speed index 7.65 m/s.
- **Extreme Precipitation (NH-11)** - score 4.0/10 (MC 4.0-4.0), weight 0.0132, data quality medium. Evidence: screening extreme-precipitation index 0.19 mm; screening precipitation index 17.4 mm/yr.
...
Brăila is Romania's fifth-ranked exclusionary-pass site in the current country ledger. It remains avoidance-flagged and therefore should be treated as an unlock candidate rather than a first-wave full-pass site. The 6.784 composite score is strong enough to keep the site in the Romanian follow-up set, but the D stability band and 0% national top-10 hit rate mean that sequencing should follow Turceni, Rovinari, and the other full-pass Romanian candidates unless Brăila's controlling issues are retired. Stage 3 preparation should focus on liquefaction, emergency-route modelling, military-feature classification, ecological permitting, land envelope confirmation, and grid-voltage pathway.
...
| Extreme Precipitation (NH-11)       | Screening reanalysis 1991-2020: screening precipitation index 17 mm/yr, extreme daily 0.2 mm; SPI12, snow-months and freezing-days not measured                                                                                 | Screening grid is too coarse to set the design rainfall and snow-load envelope; values physically implausible                                                                                  | Re-measure with ANM (Administraţia Naţională de Meteorologie) station data and complete the precipitation sub-criteria                                             | hydrology          |

Two concerns dominate the register. NH-03 is an engineering question: the high liquefaction susceptibility on deep alluvium, combined with the 0.21 g 475-year PGA, is the Stage 3 measurement that most affects the cost envelope and module placement. NS-08 is the principal permitting question: the nearby Natura 2000 context makes early environmental scoping essential. The remaining entries are characterisation gaps and engineering precursors rather than findings against the site. Brăila remains in active contention as an avoidance-flagged Romanian unlock candidate, ranking fifth nationally with a D stability band and a 6.784 baseline composite.
