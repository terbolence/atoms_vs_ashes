...
- **Extreme Winds (NH-10)** - score 9.5/10 (MC 9.0-10.0), weight n/a, data quality medium. Evidence: screening wind-speed index 5.36 m/s.
- **Extreme Precipitation (NH-11)** - score 4.0/10 (MC 4.0-4.0), weight 0.0132, data quality medium. Evidence: screening extreme-precipitation index 0.29 mm; screening precipitation index 27.3 mm/yr.
...
Rovinari is Romania's second-ranked full-pass site in the current country ledger. Its 7.159 composite score and B stability band make it a credible fast follower after Turceni, rather than a marginal avoidance-led case. The Monte Carlo interval remains wide enough to justify targeted evidence upgrades, especially for military-feature classification, emergency planning, liquid-pathway evidence, meteorology, and grid-voltage confirmation. Those tasks narrow the Stage 3 evidence envelope; they do not change the current full-pass screening status.
