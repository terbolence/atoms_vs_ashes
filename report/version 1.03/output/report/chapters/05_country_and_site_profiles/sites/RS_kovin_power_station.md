...
- **Government of Serbia** (nan% share), headquartered in Serbia; immediate operator Government of Serbia. Path: Government of Serbia  -> Kovin power station Unit 1 [unknown %]
...
- **Geotechnical: Slope Stability (NH-04)** - score 9.5/10 (MC 9.0-10.0) — favorable: Well below the risk boundary., weight n/a, data quality screening grade. Evidence: site slope 1.68 deg; max slope in 1 km box 12.9 deg; slope stability class: flat.
...
- **Coastal Flooding (NH-08)** - score 9.5/10 (MC 9.0-10.0) — favorable: Non-coastal OR elevation >= 50 m AMSL OR landlocked country, with no positive marine-hazard signal., weight 0.0303, data quality medium. Evidence: distance to coast 317.5 km.
- **River Flooding (NH-09)** - score 7.5/10 (MC 7.0-8.0), weight 0.0404, data quality medium. Evidence: flood zone class: negligible.
- **Extreme Winds (NH-10)** - score 5.5/10 (MC 5.0-6.0) — pass-mark band: Middle relative wind exposure around the observed set mean (9.0-10.5 m/s)., weight 0.0152, data quality medium. Evidence: design wind speed 9.17 m/s.
- **Extreme Precipitation (NH-11)** - score 8.0/10 (MC 8.0-9.0) — favorable: aggregated(mean_of_sub_scores), weight 0.0152, data quality medium. Evidence: extreme daily precipitation 0.23 mm; mean annual precipitation 26.1 mm/yr.
...
<!-- specialist key=family_natural_hazards scope=site site_id=5d4aee8d-9e73-4987-907a-d092e0ba92ed bundle=RS_kovin_power_station_site_bundle.json status=pending -->
...
- **Aircraft Crash (HI-01)** - score 3.5/10 (MC 3.0-4.0), weight 0.0354, data quality high. Evidence: nearest airport 2.74 km; nearest flight path 1.37 km; airports within search radius 3; airport name: Kovin Airstrip; airport type: small_airport.
- **Industrial Explosions (HI-02)** - score 9.5/10 (MC 9.0-10.0) — favorable: Very strong margin above the score-5 boundary (or completed search confirmed no in-radius signal)., weight 0.0354, data quality medium. Evidence: nearest Seveso establishment 25.3 km; nearest industrial site 25.3 km.
- **Toxic/Gas Releases (HI-03)** - score 7.5/10 (MC 7.0-8.0), weight 0.0354, data quality medium. Evidence: nearest toxic source 29.4 km.
- **External Fires (HI-04)** - score 9.5/10 (MC 9.0-10.0) — favorable: > 15 km, or completed flammable-storage search found nothing in radius., weight 0.0303, data quality medium. Evidence: nearest flammable storage 25.3 km.
...
<!-- specialist key=family_human_hazards scope=site site_id=5d4aee8d-9e73-4987-907a-d092e0ba92ed bundle=RS_kovin_power_station_site_bundle.json status=pending -->
...
- **Population Projections (RI-06)** - score 9.5/10 (MC 9.0-10.0) — favorable: Declining (< -0.5 %/yr)., weight 0.0253, data quality screening grade. Evidence: annual population growth rate -1.016 %/yr; projected population at 25 km in 60 yr 137,862 people.

### Interpretation - Radiological Impact and Emergency Planning (RI / EP)


<!-- specialist key=family_radiological_emergency scope=site site_id=5d4aee8d-9e73-4987-907a-d092e0ba92ed bundle=RS_kovin_power_station_site_bundle.json status=pending -->
...
- **Transport Access (NS-03)** - score 8.0/10 (MC 6.0-10.0) — favorable: aggregated(weighted_mean_of_sub_scores), weight 0.0404, data quality low. Evidence: nearest waterway 2.11 km; heavy-haul capable: yes.
...
- **Site Footprint Adequacy (NS-05)** - score 9.5/10 (MC 9.0-10.0) — favorable: Very strong margin above the score-5 boundary., weight 0.0253, data quality medium. Evidence: buildable area 7.86 ha; largest contiguous patch 7.86 ha; buildable patch count 1.
...
<!-- specialist key=family_infrastructure scope=site site_id=5d4aee8d-9e73-4987-907a-d092e0ba92ed bundle=RS_kovin_power_station_site_bundle.json status=pending -->
...
![Criterion scores](../figures/RS_kovin_power_station_criterion_scores.png)

![Family contributions](../figures/RS_kovin_power_station_family_contributions.png)

<!-- specialist key=stability scope=site site_id=5d4aee8d-9e73-4987-907a-d092e0ba92ed bundle=RS_kovin_power_station_site_bundle.json status=pending -->
...
<!-- specialist key=residual_risk scope=site site_id=5d4aee8d-9e73-4987-907a-d092e0ba92ed bundle=RS_kovin_power_station_site_bundle.json status=pending -->
...
- [ ] Resolve **Aircraft Crash (HI-01)** avoidance flag - measured {"flight_path_distance_km": 1.37, "under_flight_path": false} vs threshold A4 — SSG-35: flight-path overhead / < 4 km from airway (large + medium classes only)..
