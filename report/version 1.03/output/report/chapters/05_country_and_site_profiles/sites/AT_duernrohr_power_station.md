...
- **Wiener Stadtwerke GmbH** (nan% share), headquartered in Austria; immediate operator Verbund Thermal Power GmbH & Co KG. Path: Wiener Stadtwerke GmbH -> Verbund AG [unknown %] -> Verbund Thermal Power GmbH & Co KG [100.0%] -> Duernrohr power station Unit 1 [100.0%]
- **Government of Austria** (51.00% share), headquartered in Austria; immediate operator Verbund Thermal Power GmbH & Co KG. Path: Government of Austria  -> Verbund AG [51.0%] -> Verbund Thermal Power GmbH & Co KG [100.0%] -> Duernrohr power station Unit 1 [100.0%]
- **EVN AG** (100.00% share), headquartered in Austria; immediate operator EVN AG. Path: EVN AG -> Duernrohr power station Unit 2 [100.0%]
- **Verbund AG** (100.00% share), headquartered in Austria; immediate operator Verbund Thermal Power GmbH & Co KG. Path: Verbund AG -> Verbund Thermal Power GmbH & Co KG [100.0%] -> Duernrohr power station Unit 1 [100.0%]
- **TIWAG-Tiroler Wasserkraft AG** (4.00% share), headquartered in Austria; immediate operator Verbund Thermal Power GmbH & Co KG. Path: TIWAG-Tiroler Wasserkraft AG -> Verbund AG [4.0%] -> Verbund Thermal Power GmbH & Co KG [100.0%] -> Duernrohr power station Unit 1 [100.0%]
- **small shareholder(s)** (19.00% share); immediate operator Verbund Thermal Power GmbH & Co KG. Path: small shareholder(s)  -> Verbund AG [19.0%] -> Verbund Thermal Power GmbH & Co KG [100.0%] -> Duernrohr power station Unit 1 [100.0%]

Generating units on record: 2 retired.
Earliest unit commissioning: 1985; most recent: 1987.
Retirements span 2015 to 2019, leaving brownfield grid, water, transport, and workforce assets that materially shorten Stage 3 site preparation.
...
- **Seismic: Surface Rupture (NH-02)** - score 7.5/10 (MC 7.0-8.0), weight n/a, data quality screening grade. Evidence: nearest mapped capable fault 23.9 km; fault slip rate 0.022 mm/yr; fault name: ATCF008; E1 verdict (radius 5 km): outside the SSG-9 capable-fault screening envelope.
...
- **Coastal Flooding (NH-08)** - score 9.5/10 (MC 9.0-10.0) — favorable: Non-coastal OR elevation >= 50 m AMSL OR landlocked country, with no positive marine-hazard signal., weight 0.0303, data quality medium. Evidence: distance to coast 333.3 km.
- **River Flooding (NH-09)** - score 7.5/10 (MC 7.0-8.0), weight 0.0404, data quality medium. Evidence: flood zone class: negligible.
- **Extreme Winds (NH-10)** - score 3.5/10 (MC 3.0-4.0), weight 0.0152, data quality medium. Evidence: design wind speed 11.1 m/s.
- **Extreme Precipitation (NH-11)** - score 8.0/10 (MC 8.0-9.0) — favorable: aggregated(mean_of_sub_scores), weight 0.0152, data quality medium. Evidence: extreme daily precipitation 0.25 mm; mean annual precipitation 25.2 mm/yr.
...
<!-- specialist key=family_natural_hazards scope=site site_id=6e7fc4d8-636d-411a-baef-e138a5a07acc bundle=AT_duernrohr_power_station_site_bundle.json status=pending -->
...
- **Aircraft Crash (HI-01)** - score 9.5/10 (MC 9.0-10.0) — favorable: Nearest large/medium airport > 30 km, no flight-path proxy < 4 km, and no military airbase within 60 km., weight 0.0354, data quality high. Evidence: nearest airport 10.5 km; nearest flight path 7.06 km; airports within search radius 7; airport name: Tulln Heliport; airport type: heliport.
- **Industrial Explosions (HI-02)** - score 9.5/10 (MC 9.0-10.0) — favorable: Very strong margin above the score-5 boundary (or completed search confirmed no in-radius signal)., weight 0.0354, data quality high. Evidence: nearest industrial site 0.69 km.
...
<!-- specialist key=family_human_hazards scope=site site_id=6e7fc4d8-636d-411a-baef-e138a5a07acc bundle=AT_duernrohr_power_station_site_bundle.json status=pending -->
...
- **Atmospheric Dispersion (RI-01)** - score no native score (unscored — no band matched), weight 0.0303, data quality medium. Evidence: annual mean wind speed 1.35 m/s; atmospheric mixing height 548.6 m; prevailing wind direction: W.
...
<!-- specialist key=family_radiological_emergency scope=site site_id=6e7fc4d8-636d-411a-baef-e138a5a07acc bundle=AT_duernrohr_power_station_site_bundle.json status=pending -->
...
- **Transport Access (NS-03)** - score 8.0/10 (MC 8.0-9.0) — favorable: aggregated(weighted_mean_of_sub_scores), weight 0.0404, data quality high. Evidence: nearest highway 3.35 km; nearest rail line 0.02 km; nearest waterway 2.18 km; heavy-haul capable: yes.
- **Site Topography (NS-04)** - score 9.5/10 (MC 9.0-10.0) — favorable: > 80 %., weight 0.0303, data quality screening grade. Evidence: favourable land cover 92.2 %; moderate land cover 5.7 %; unfavourable land cover 2.1 %; favourable area 289.0 ha; dominant land class: 211.
- **Site Footprint Adequacy (NS-05)** - score 9.5/10 (MC 9.0-10.0) — favorable: Very strong margin above the score-5 boundary., weight 0.0253, data quality high. Evidence: buildable area 10.2 ha; largest contiguous patch 10.2 ha; buildable patch count 6.
...
<!-- specialist key=family_infrastructure scope=site site_id=6e7fc4d8-636d-411a-baef-e138a5a07acc bundle=AT_duernrohr_power_station_site_bundle.json status=pending -->
...
Baseline composite score is 6.544, bracketed by Monte Carlo at 5.864-7.081. National stability band is `H` with a top-10% hit rate of 0% across 12 scored Monte Carlo scenarios.
...
<!-- specialist key=stability scope=site site_id=6e7fc4d8-636d-411a-baef-e138a5a07acc bundle=AT_duernrohr_power_station_site_bundle.json status=pending -->
...
<!-- specialist key=residual_risk scope=site site_id=6e7fc4d8-636d-411a-baef-e138a5a07acc bundle=AT_duernrohr_power_station_site_bundle.json status=pending -->
...
- [ ] Resolve **Toxic/Gas Releases (HI-03)** avoidance flag - measured {"hi03_search_completed": true, "nearest_toxic_source_km": 0.69} vs threshold Project avoidance: >= 8 km from hazardous-cloud sources..
- [ ] Resolve **Distance to Population Centres (RI-05)** avoidance flag - measured {"nearest_city_50k_km": 35.91, "ri05_required_distance_km": 48.0} vs threshold Nearest >=50k population-centre proxy: 50k/>=8 km, 100k/>=16 km, 500k/>=32 km, 1M/>=48 km..
- [ ] Re-measure **Toxic/Gas Releases (HI-03)** - native score 0.0/10 with confidence high.
