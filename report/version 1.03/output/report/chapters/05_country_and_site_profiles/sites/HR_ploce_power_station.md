...
| Available surface area | 238.7 ha |
| Available surface area for development | 238.7 ha |
...
| --- | --- | --- | --- | --- | --- |
| Seismic: Surface Rupture | NH-02 | {"nearest_fault_km": 3.24} | Capable fault within score-5 pivot distance. | medium | TRIGGERED: E1 — Capable fault within score-5 pivot distance. |

## Unlock Analysis


<!-- specialist key=unlock_analysis scope=site site_id=7af0e000-3d19-4e5e-b504-f74897f1510c bundle=HR_ploce_power_station_site_bundle.json status=pending -->
