...
| Composite score (baseline weights) | 6.228 (5.609-6.700 MC band) |
...
- **Extreme Winds (NH-10)** - score 9.5/10 (MC 9.0-10.0), weight n/a, data quality medium. Evidence: screening wind-speed index 6.46 m/s.
- **Extreme Precipitation (NH-11)** - score 4.0/10 (MC 4.0-4.0), weight 0.0132, data quality medium. Evidence: screening extreme-precipitation index 0.28 mm; screening precipitation index 26.4 mm/yr.
...
Romag Termo is an avoidance-flagged Romanian follow-up site, not a first-wave national leader. Its 6.228 composite score keeps it inside the Romanian evidence base, but the H stability band and 0% national top-10 hit rate make it rank-fragile compared with Turceni, Rovinari, Iernut, Mintia-Deva, and Brăila. The site remains strategically useful because of land, rail, cooling, and inherited infrastructure indicators; its Stage 3 value depends on retiring the toxic-release, military-feature, aviation, population-density, cooling-loop, and grid-voltage questions identified below.
...
| Grid Connection (NS-02) | Nearest substation 1.81 km, nearest HV line 0.98 km at 110 kV; 1,065 MW export capacity (screening fallback against the installed-capacity register) | 110 kV interconnection is below the 220-400 kV typically preferred for new nuclear; the 1,065 MW figure carries comfortable headroom against the 462 MWe VOYGR-6 (6 × 77 MWe modules) reference output, but the interconnection upgrade is still required | Confirm Transelectrica corridor upgrade pathway to 220 kV / 400 kV and update NS-02 against the planned topology | grid |

Two concerns dominate the register. HI-03 is the active avoidance flag and the single Stage 3 unlock that most affects the standing of this site: confirming the 3.25 km toxic-source identity and dispersion footprint either closes out the flag or converts it into a binding facility-siting concern. HI-06 is the secondary governance question. The remaining entries are characterisation gaps and engineering precursors rather than findings against the site. Romag Termo remains in active contention as a Romanian comparator and unlock candidate, but it ranks eleventh nationally with an H stability band and a 6.228 baseline composite.

## Stage 3 Follow-Up Checklist

- Resolve **Toxic/Gas Releases (HI-03)** avoidance flag - measured toxic-source distance 3.25 km against the 8 km hazardous-cloud separation screen.
