...
- The controlling editorial documents at
  `report/version 1.03/output/report/writing plan/` (writingDecisions,
  v1_3_iteration_controls, writingStyle, tableOfContents).
- The frozen baseline inherited from version 1.2 at
  `report/version 1.02/v1_2_report_preparation/v1_2_baseline_decision.md`.
- The historical Ovidiu closure register at
  `report/version 1.02/v1_2_report_preparation/ovidiu_v1_2_closure_register.md`, and the version 1.3 closure register produced for the new feedback round when available.
...
The auditor scans the active Ovidiu closure register (`ovidiu_v1_2_closure_register.md` for inherited items, and the version 1.3 closure register for the new feedback round) and verifies
