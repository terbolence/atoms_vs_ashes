...
The version 1.02 default (carried into 1.2 and 1.3) has **one prompt** for the entire report:
...
For version 1.3, this remains a default, not a quality ceiling. Use one
