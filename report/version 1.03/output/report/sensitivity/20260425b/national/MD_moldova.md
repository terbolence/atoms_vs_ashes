# Moldova (MD) — sensitivity shortlist — 20260425b

_Generated on 2026-04-25 (UTC)._

## Envelope

- Scored sites (all-SMR pool): **1**.
- Scored sites (NuScale pool): **1**.
...
![Top sites in Moldova](figures/MD_top_sites.png)

## Ranked shortlist — all SMRs pooled (top 10)

| Rank | Site | Country | Band | Top-5 % rate | Top-10 % rate | Top-30 % rate |
| ---: | --- | --- | :---: | ---: | ---: | ---: |
| 1 | Kuchurgan power station | MD | A | 1.0 | 1.0 | 1.0 |

**Band counts:** A=1, B=0, C=0, D=0, E=0, F=0, G=0, H=0.
...
**NuScale band counts:** A=1, B=0, C=0, D=0, E=0, F=0, G=0, H=0.
...
- Sources: `20260425b_site_bands_MD.csv`, `20260425b_site_bands_MD_nuscale_voygr6.csv`.
