# Slovakia (SK) — sensitivity shortlist — 20260425b
...
![Top sites in Slovakia](figures/SK_top_sites.png)

## Ranked shortlist — all SMRs pooled (top 10)

| Rank | Site | Country | Band | Top-5 % rate | Top-10 % rate | Top-30 % rate |
| ---: | --- | --- | :---: | ---: | ---: | ---: |
| 1 | Vojany I power station | SK | A | 1.0 | 1.0 | 1.0 |
| 2 | Novaky power station | SK | D | 0.0 | 0.0 | 1.0 |
| 3 | Martinska power station | SK | H | 0.0 | 0.0 | 0.0 |
| 4 | Trebisov power station | SK | H | 0.0 | 0.0 | 0.0 |
| 5 | U.S. Steel Kosice Works power station | SK | H | 0.0 | 0.0 | 0.0 |

**Band counts:** A=1, B=0, C=0, D=1, E=0, F=0, G=0, H=3.
...
| ---: | --- | --- | :---: | ---: | ---: | ---: |
| 1 | Vojany I power station | SK | A | 1.0 | 1.0 | 1.0 |
| 2 | Martinska power station | SK | H | 0.0 | 0.0 | 0.0 |
| 3 | Trebisov power station | SK | H | 0.0 | 0.0 | 0.0 |
| 4 | U.S. Steel Kosice Works power station | SK | H | 0.0 | 0.0 | 0.0 |
| 5 | Novaky power station | SK | H | 0.0 | 0.0 | 0.0 |

**NuScale band counts:** A=1, B=0, C=0, D=0, E=0, F=0, G=0, H=4.
...
- Sources: `20260425b_site_bands_SK.csv`, `20260425b_site_bands_SK_nuscale_voygr6.csv`.
