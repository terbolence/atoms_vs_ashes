# Phase 1.6 failure-mode analysis — 20260425 — NuScale VOYGR-6
...
Source artefacts:
- `audit/post_processing/06_scoring/per_smr/nuscale_voygr6/20260425_failure_summary.csv` — top-level counts.
- `audit/post_processing/06_scoring/per_smr/nuscale_voygr6/20260425_failure_per_criterion.csv` — per-criterion fails.
- `audit/post_processing/06_scoring/per_smr/nuscale_voygr6/20260425_failure_per_country.csv` — per-country fails.
- `audit/post_processing/06_scoring/per_smr/nuscale_voygr6/20260425_failure_per_pair.csv` — one row per (site, SMR).
...
![Failure funnel](../output/sensitivity/20260425/figures/failure/per_smr/nuscale_voygr6/failure_funnel.png)
...
![Failures by criterion](../output/sensitivity/20260425/figures/failure/per_smr/nuscale_voygr6/failures_by_criterion.png)
...
![Per-country outcomes](../output/sensitivity/20260425/figures/failure/per_smr/nuscale_voygr6/failures_by_country.png)
...
![Multi-failure histogram](../output/sensitivity/20260425/figures/failure/per_smr/nuscale_voygr6/multi_failure_histogram.png)
