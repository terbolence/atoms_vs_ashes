...
5. Align language with project evidence grades (**screening-grade**, **ranking-grade**, **characterization-grade**, **insufficient**) — see `experts/connectors/software_architect.md` §D2.
...
| `experts/connectors/software_architect.md` | Stack, tables, evidence grades, 23-country scope |
