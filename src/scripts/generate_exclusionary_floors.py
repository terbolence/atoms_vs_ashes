...
def render_document(bundle: dict[str, Criterion]) -> str:
    ...
    blocks: list[str] = [
        ...
        "",
        "> **Reader-facing summary:** the report-audience version of these "
        "exclusionary bands lives in "
        "[`annex_b_scoring_methodology_and_exclusionary_floors.md`]"
        "(../output/report/annexes/annex_b_scoring_methodology_and_exclusionary_floors.md). "
        "This file is the engineering-audit surface; Annex B is the "
        "reader-facing summary surface. Per the Phase 5c redundancy "
        "inventory the two surfaces are retained as a deliberate "
        "two-audience treatment under SST rule 2.",
        "",
