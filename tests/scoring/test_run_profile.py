...
def test_baseline_profile_loads():
    out = load_run_profile(REPO_ROOT / "config/run_profiles/baseline.yaml")
...
def test_ro_focus_profile_loads():
    out = load_run_profile(REPO_ROOT / "config/run_profiles/ro_focus.yaml")
...
def test_qualification_mode_default_normal():
    out = load_run_profile(REPO_ROOT / "config/run_profiles/baseline.yaml")
